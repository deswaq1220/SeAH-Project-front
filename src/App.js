  ...
  return (
    <Router>
      <Routes>
        ...
        {/* 공통 */}
        <Route path="/frequentinspection" element={<Error />}></Route>{/* 공통 수시점검 현황*/}
        <Route path="/all/special/detail/:speId" element={<Error />}></Route>{/* 공통 수시점검 상세페이지 */}
        ...
        {/* 사용자 수시점검 */}
        <Route path="/special/:masterdataPart/:masterdataId" element={<Error />}></Route>  {/* 사용자 점검선택페이지*/}
        <Route path="/special/list/:masterdataPart/:masterdataId" element={<Error />}></Route>  {/* 사용자 수시점검 설비별 리스트페이지*/}
        <Route path="/special/new/:masterdataPart/:masterdataId" element={<Error />}></Route>{/* 사용자 수시점검등록페이지 */}
        <Route path="/userfrequentreg" element={<Error />}></Route>{/* 수시점검 등록페이지 */}
        <Route path="/special/detail/:speId" element={<Error />}></Route>{/* 수시점검 상세페이지 */}

        {/* 사용자 정기점검 */}
        <Route path="/regularreg" element={<Error />}></Route>{/* 정기점검 등록페이지 */}
        <Route path="/faultymodal" element={<Error />}></Route>{/* 수시점검 상세페이지 */}

        <Route path="/404" element={<Error />}></Route> {/* 에러 */}
        <Route path="/detailmodal" element={<Error />}></Route> {/* 에러 */}
      </Routes>
      <ToastContainer />
    </Router>
