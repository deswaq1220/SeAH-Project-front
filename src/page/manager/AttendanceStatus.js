...
export default function AttenStatus() {
  ...
  useEffect(() => {
    ...
    const fetchAttendanceData = async () => {
      ...
      try {
        const response = await fetcher.get(`/usereduatten/list/${eduId}`, {
          headers: {
      ...
      <div className="px-4 sm:px-6 lg:px-8 mx-4 mt-6">
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            <h1 className="text-xl font-extrabold leading-6 text-gray-900">
              {eduData.eduTitle}
            </h1>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {attendanceList.map((attendance) => (
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap p-4 text-sm text-gray-500">
                        {formatTime(attendance.attenTime)}
                      </td>
                    </tr>
                  ))}
                </tbody>
