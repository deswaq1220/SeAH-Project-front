          ...
          <table className="min-w-full divide-y divide-gray-300">
            <thead>
              <tr>
                <th
                  scope="col"
                  className="py-3.5 pl-4 pr-3 text-sm text-left font-semibold text-gray-900 sm:pl-0"
                >
                  번호
                </th>
                <th
                  ...
                  <td>
                    {regularDetail.regularCheck === "BAD" ? (
                      regularDetail.regularComplete !== "OK" ? (
                        ...
                        <button
                          type="button"
                          className="rounded-md bg-gray-100 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-seahColor"
                        >
                          조치 완료
                        </button>
                      )
