                  ...
                  <div className="mt-3 text-left sm:mt-5">
                    ...
                    <div className="mt-2">
                      <textarea
                        ...
                        name="comment"
                        id="comment"
                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-seahColor sm:text-sm sm:leading-6 disabled:bg-gray-200 disabled:text-gray-800 disabled:ring-gray-300"
                      ...
                      <div className="flex flex-wrap">
                        <div className="mt-2 mr-2">
                          <input
                            ...
                            disabled
                            className="block w-auto rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 disabled:cursor-not-allowed disabled:bg-gray-200 disabled:text-gray-800 disabled:ring-gray-300 sm:text-sm sm:leading-6"
                          />
                        </div>
                        <div className="mt-2">
                          <input
                            ...
                            disabled
                            className="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 disabled:cursor-not-allowed disabled:bg-gray-200 disabled:text-gray-800 disabled:ring-gray-300 sm:text-sm sm:leading-6"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-10">
                      ...
                      {/* 이미지를 표시할 부분 */}
                      {fetchData?.afterFilePath &&
                      fetchData?.afterFilePath.length > 0 ? (
                        <div>
