          ...
          if (item.regularActEmail) {
            ...
            const spendForm = `
                                          ...
                                          <tr>
                                            ...
                                            <p style="font-size:16px;">링크 : <a href="http://localhost:3000/regulardetails/${response.data.regularId}">상세보기</a></p>
  ...
  return (
    <div className="flex flex-col ">
      ...
      <div className="flex items-center ml-4 flex-wrap">
        <span className=" w-20 inline-flex items-center justify-center rounded-md bg-red-50 px-3 py-1 text-sm font-medium text-seahColor ring-1 ring-inset ring-red-600/10 flex-grow-0 mr-8 my-4 ">
          점검항목
        </span>
        <div>
        <Listbox
